...
// Retorna 'true' se chegamos na página via GET (ou seja, diferente de POST); retorna 'false' se chegarmos na página via POST
       return $_SERVER['REQUEST_METHOD'] != "POST";
   
}

// Função para verificar se os valores digitados no form são valores numéricos
